#!/usr/bin/python
# Find the matched column by "New VTTH code", paste several data columns from List ERP to original file
# Manually find errors and misinformation
...
def write_to_excel(row_in_first_file, row_in_second_file):
    ...
    if DEFINE_SHEET == 1:
        ...
        first_column = 17
        second_column = 18
    ws.cell(row=row_in_first_file, column=first_column).value = ws2.cell(None, row_in_second_file, 3).value
...
des_file = excel_path_suffix + 'CDCC' + '_out' + '.xlsx'
